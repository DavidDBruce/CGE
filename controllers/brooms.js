...
api.get("/", function (request, response) {
    response.render("brooms/index.ejs");
});
...
api.get('/delete/:id', function (req, res) {
    ...
    return res.render('brooms/delete.ejs',
        {
            title: "Estimates",
            layout: "layout.ejs",
            estimate: item
...
api.get('/details/:id', function (req, res) {
    ...
    if (!item) { return res.end(notfoundstring); }
    console.log("RETURNING VIEW FOR" + JSON.stringify(item));
    return res.render('brooms/details.ejs',
        {
            title: "Estimates",
            layout: "layout.ejs",
            estimate: item
...
api.get('/edit/:id', function (req, res) {
    ...
    if (!item) { return res.end(notfoundstring); }
    console.log("RETURNING VIEW FOR" + JSON.stringify(item));
    return res.render('brooms/edit.ejs',
        {
            title: "Estimates",
            layout: "layout.ejs",
            estimate: item
