...
var Model = require('../models/ladder.js');
const notfoundstring = 'No such ladders';

// GET to this controller root URI
api.get("/", function (req, res) {
    return res.render('ladders/index.ejs');
});

api.get('/findall', function (req, res) {
    res.setHeader('Content-Type', 'application/json');
    var data = req.app.locals.ladders.query;
...
api.get('/create', function (request, response) {
    response.render("ladders/create.ejs");
});
...
api.get('/delete/:id', function (req, res) {
    ...
    return res.render('ladders/delete.ejs',
        {
            title: "RP",
            layout: "layout.ejs",
            ladders: item
...
api.get('/details/:id', function (req, res) {
    ...
    if (!item) { return res.end(notfoundstring); }
    console.log("RETURNING VIEW FOR" + JSON.stringify(item));
    return res.render('ladders/details.ejs',
        {
            title: "RP",
            layout: "layout.ejs",
            ladders: item
...
api.get('/edit/:id', function (req, res) {
    ...
    if (!item) { return res.end(notfoundstring); }
    console.log("RETURNING VIEW FOR" + JSON.stringify(item));
    return res.render('ladders/edit.ejs',
        {
            title: "RP",
            layout: "layout.ejs",
            ladders: item
